...
head(Meta(gse))
names(GSMList(gse))
as.list(names(GSMList(gse54002)))

fistdw = getGEOSuppFiles('GSM26804')

#We must make the list of GSM to download:
Lista1 <-list('GSM241999','GSM158644','GSM110625','GSM241999')
...
(names(GSMList(gse54002)))[!(names(GSMList(gse54002)) %in% alreadyvector)]
sapply(as.list((names(GSMList(gse54002)))[!(names(GSMList(gse54002)) %in% alreadyvector)]),function(x){ getGEOSuppFiles(x)})
...
function(ListaGSEs){
  for(i in 1:length(listaGSEs)){
    getGEO(listaGSEs[i],GSEMatrix=FALSE)

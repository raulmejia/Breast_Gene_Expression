...
KEGG_pathways_in_df<-list_of_chr_to_df(pw_1$kg.sets)
write.table(KEGG_pathways_in_df,file="KEGG_pathways_in_df.tsv",sep="\t",col.names = FALSE,quote = FALSE)
save(KEGG_pathways_in_df,file="KEGG_pathways_in_df.RData")

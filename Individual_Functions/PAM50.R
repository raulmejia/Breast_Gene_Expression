...
paramDir<- "/home/rmejia/Documents/Doctorado/METABRIC/PAM50TrialLimpio/bioclassifier_R" # the location of unchanging files such as the function library and main program
inputDir<- "/home/rmejia/Documents/Doctorado/METABRIC/PAM50TrialLimpio/bioclassifier_example"  # the location of the data matrix, and where output will be located
